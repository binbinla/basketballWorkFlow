...
class Button extends React.Component {
    ...
    render() {
        ...
        // </Text>          
        //   </TouchableOpacity>
        React.createElement(react_native_1.TouchableOpacity, { activeOpacity: 0.8, onPress: () => { this.props.onButtonClick(); }, disabled: buttonDisabled },
            React.createElement(react_native_1.View, { style: [styles.container, this.props.style, { backgroundColor: bgColor }] },
