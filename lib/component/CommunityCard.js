...
class CommunityCard extends React.Component {
    ...
    render() {
        const newsTitle = news_datas_1.default[this.props.communityId].newsTitle;
        const newsImage = news_datas_1.default[this.props.communityId].newsImage;
        const newsComment = news_datas_1.default[this.props.communityId].commentCount;
