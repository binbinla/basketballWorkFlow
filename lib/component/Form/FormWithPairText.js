...
class FormWithPairText extends React.Component {
    constructor(props) {
        ...
        this.renderArrowRight = () => {
            return (React.createElement(react_native_1.View, { style: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center' } },
                React.createElement(react_native_1.Text, { style: [styles.rightText] }, this.props.rightText),
                React.createElement(react_native_1.Image, { style: styles.image, source: require('../../../assets/img/indicate/arrow-right.png') })));
        };
    }
    render() {
        ...
        return (React.createElement(react_native_1.TouchableOpacity, { activeOpacity: 0.5, onPress: () => { this.props.onFormClick(); } },
            React.createElement(react_native_1.View, { style: [styles.container, this.props.style, cutOffLineStyle] },
                React.createElement(react_native_1.Text, { style: [styles.leftText] }, this.props.leftText),
