    ...
    render() {
        return (React.createElement(react_native_1.TouchableOpacity, { activeOpacity: 0.5, onPress: () => { this.props.onFormClick(); } },
            React.createElement(react_native_1.View, { style: [styles.container] },
                React.createElement(react_native_1.Image, { source: require('../../../assets/img/indicate/snail.jpg'), style: styles.leftImage }),
                React.createElement(react_native_1.View, { style: styles.textContainer },
                    React.createElement(react_native_1.Text, { style: [styles.nickNameText] }, this.props.nickName),
                    React.createElement(react_native_1.Text, { style: [styles.contactText] }, this.props.contactText)),
                React.createElement(react_native_1.Image, { source: require('../../../assets/img/indicate/arrow-right.png'), style: styles.rightImage }))));
    }
}
