    ...
    _renderDefaultContent() {
        if (this.props.hudBg) {
            return (React.createElement(react_native_1.View, { style: styles.background },
                React.createElement(react_native_1.View, { style: styles.hud },
                    React.createElement(react_native_1.ActivityIndicator, { color: this.props.color || colors_1.commonColors.white, size: this._mapSize(this.props.size || SIZES.LARGE) }),
                    React.createElement(react_native_1.Text, { style: [styles.hudText, this.props.textStyle] }, this.state.textContent))));
        }
        else {
            return (React.createElement(react_native_1.View, { style: styles.background },
