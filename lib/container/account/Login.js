    ...
    render() {
        return (React.createElement(react_native_1.View, { style: styles.container },
            React.createElement(react_native_1.View, { style: styles.card },
                React.createElement(react_native_textinput_effects_1.Hoshi, { style: { marginLeft: 15, marginRight: 15 }, label: '账号', maskColor: '#F9F7F6', borderColor: '#b76c94', onChangeText: (text) => { this.setState({ account: text }); } }),
                React.createElement(react_native_textinput_effects_1.Hoshi, { style: { marginTop: 20, marginLeft: 15, marginRight: 15 }, label: '密码', maskColor: '#F9F7F6', borderColor: '#b76c94', secureTextEntry: true, onChangeText: (text) => { this.setState({ password: text }); } })),
