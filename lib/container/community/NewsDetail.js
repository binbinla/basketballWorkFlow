...
class NewsDetail extends React.Component {
    constructor(props) {
        ...
        this._renderRow = (rowData, sectionID, rowID, highlightRow) => {
            return (React.createElement(CommentCard_1.default, { user: this.props.loginParams.user, commentContent: '希望老詹下一场别再打这么久了，把身体留着来76人多打几年' }));
        };
        /**
         * 接收输入框回调
         */
    ...
    render() {
        ...
        return (React.createElement(react_native_1.View, { style: { flex: 1 } },
            React.createElement(react_native_1.ScrollView, { style: { flex: 1, marginBottom: 40 }, showsVerticalScrollIndicator: false },
                        ...
                        React.createElement(react_native_1.View, { style: styles.modalContent },
                            React.createElement(react_native_1.View, { style: styles.partOne },
                                ...
                                React.createElement(react_native_1.TouchableOpacity, { onPress: this._onPostPress },
                                    React.createElement(react_native_1.Text, { style: styles.cornerText }, '发表'))),
