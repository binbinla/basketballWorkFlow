...
class ChangeAddress extends React.Component {
    ...
    render() {
        return (React.createElement(react_native_1.View, { style: styles.container },
            React.createElement(InputForm_1.default, { style: { marginTop: 15 }, value: this.state.originText, inputCallback: this._inputCallback }),
            React.createElement(react_native_easy_toast_1.default, { ref: "toast", position: "center" })));
    }
}
ChangeAddress.navigationOptions = ({ navigation, screenProps }) => ({
    title: '地址',
    tabBarVisible: false,
...
function mapDispatchToProps() {
    return (dispatch) => ({
        modifyAddress: (address) => dispatch(loginAction.modifyAddress(address))
    });
}
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(ChangeAddress);
//# sourceMappingURL=ChangeAddress.js.map