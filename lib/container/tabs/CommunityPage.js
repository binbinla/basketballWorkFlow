...
const CommunityCard_1 = __importDefault(require("../../component/CommunityCard"));
...
class CommunityPage extends React.Component {
    ...
    render() {
        return (React.createElement(react_native_1.View, { style: styles.container },
            ...
            React.createElement(GiftedListView, { style: { flex: 1 }, rowView: this._renderRowView.bind(this), onFetch: this._onFetch.bind(this), firstLoader: true, pagination: false, refreshable: false, withSections: true, sectionHeaderView: this._renderSectionHeaderView, paginationAllLoadedView: this._renderPaginationAllLoadedView, customStyles: {
                    paginationView: {
    ...
    _onFetch(page, callback, options) {
        setTimeout(() => {
            const ids = this.props.communityParams ? this.props.communityParams.ids : [];
            let result = {};
            result['社区话题'] = ids;
            callback(result);
        }, 1500);
    ...
    */
    ...
    _renderRowView(rowData) {
        ...
        , { 
            ...
            React.createElement(CommunityCard_1.default, { communityId: rowData })));
    }
