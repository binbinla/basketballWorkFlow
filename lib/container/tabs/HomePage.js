...
class HomePage extends React.Component {
    ...
    render() {
        return (React.createElement(react_native_1.View, { style: styles.container },
            React.createElement(GiftedListView, { style: { flex: 1 }, rowView: this._renderRowView.bind(this), onFetch: this._onFetch.bind(this), firstLoader: true, pagination: false, refreshable: false, withSections: true, sectionHeaderView: this._renderSectionHeaderView, emptyView: this._renderEmptyView.bind(this), customStyles: {
                    paginationView: {
