...
class HomePage extends React.Component {
    ...
    render() {
        return (React.createElement(react_native_1.View, { style: styles.container },
            React.createElement(GiftedListView, { style: { flex: 1 }, rowView: this._renderRowView.bind(this), onFetch: this._onFetch.bind(this), firstLoader: true, pagination: false, refreshable: true, withSections: true, sectionHeaderView: this._renderSectionHeaderView, customStyles: {
                    paginationView: {
    ...
    _onFetch(page = 1, callback, options) {
        setTimeout(() => {
            let result = {};
            result[`${this.props.gamesParams['today'].gameDate}${' '}${date.getWeekDay(1 /* today */)}`] = this.combineGames(1 /* today */);
            result[`${this.props.gamesParams['yesterday'].gameDate}${' '}${date.getWeekDay(2 /* yesterday */)}`] = this.combineGames(2 /* yesterday */);
            // let result = {};
