        ...
        return (React.createElement(react_native_1.View, { style: styles.container },
            React.createElement(react_native_1.ScrollView, { style: { flex: 1 } },
                React.createElement(react_native_1.View, { style: styles.partContainer },
                    React.createElement(FormWithPicture_1.default, { nickName: '大陈', contactText: '188****6910', pictureUri: '../../../assets/img/indicate/snail.jpg', onFormClick: () => this.aboutTheApp() }),
                    React.createElement(FormWithPairText_1.default, { leftText: "\u6211\u7684\u79EF\u5206", rightText: "180", onFormClick: () => this.aboutTheApp(), cutOffLine: false })),
                React.createElement(react_native_1.View, { style: styles.partContainer },
                    React.createElement(FormArrowToDetail_1.default, { leftText: '账户安全', onFormClick: () => this.aboutTheApp(), cutOffLine: false })),
                React.createElement(react_native_1.View, { style: styles.partContainer },
                    React.createElement(FormArrowToDetail_1.default, { leftText: '帮助与反馈', onFormClick: () => this.aboutTheApp() }),
                ...
                React.createElement(Button_1.default, { style: { marginTop: 15, backgroundColor: colors_1.commonColors.topicColor }, text: "\u9000\u51FA\u767B\u5F55", onButtonClick: () => { } }))));
    }
}
