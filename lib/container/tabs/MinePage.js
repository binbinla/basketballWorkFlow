        ...
        return (React.createElement(react_native_1.View, { style: styles.container },
            React.createElement(react_native_1.ScrollView, { style: { flex: 1 } },
                React.createElement(react_native_1.View, { style: styles.partContainer },
                    ...
                    React.createElement(FormWithPairText_1.default, { leftText: "\u6211\u7684\u79EF\u5206", rightText: String(this.state.userIntegral), onFormClick: () => { }, cutOffLine: false })),
                React.createElement(react_native_1.View, { style: styles.partContainer },
                    React.createElement(FormArrowToDetail_1.default, { leftText: '我的主队', onFormClick: () => this.mySupportTeam(), cutOffLine: false })),
                React.createElement(react_native_1.View, { style: styles.partContainer },
                    React.createElement(FormArrowToDetail_1.default, { leftText: '意见与反馈', onFormClick: () => this.helpAndFeedback() }),
                    React.createElement(FormArrowToDetail_1.default, { leftText: '给个好评鼓励一下吧', onFormClick: () => this.evaluateApp() }),
