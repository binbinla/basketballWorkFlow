...
const NewsPage_1 = __importDefault(require("./NewsPage"));
...
const CommunityDetail_1 = __importDefault(require("../../container/community/CommunityDetail"));
...
const NewsWebView_1 = __importDefault(require("../community/NewsWebView"));
const CommunityPage_1 = __importDefault(require("./CommunityPage"));
const MineStarTeam_1 = __importDefault(require("../mine/MineStarTeam"));
...
const NewsStack = react_navigation_1.StackNavigator({
    NewsPage: { screen: NewsPage_1.default },
    NewsWebView: { screen: NewsWebView_1.default }
}, {
    navigationOptions: {
        headerStyle: {
            backgroundColor: colors_1.commonColors.topicColor,
...
const CommunityStack = react_navigation_1.StackNavigator({
    ...
    CommunityDetail: { screen: CommunityDetail_1.default },
}, {
    navigationOptions: {
        headerStyle: {
            backgroundColor: colors_1.commonColors.topicColor,
...
const MineStack = react_navigation_1.StackNavigator({
    ...
    MineStarTeam: { screen: MineStarTeam_1.default }
}, {
    navigationOptions: {
        headerStyle: {
            backgroundColor: colors_1.commonColors.topicColor,
