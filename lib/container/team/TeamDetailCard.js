...
class TeamDetailCard extends React.Component {
    ...
    render() {
        ...
        const bg = team_map_1.default[this.props.teamItem.name].color;
        return (React.createElement(react_native_1.View, { style: [styles.container, { backgroundColor: bg }] },
            ...
            React.createElement(react_native_1.View, { style: styles.rightContainer },
                React.createElement(react_native_1.Text, { style: styles.rightText }, `${this.props.teamDetail.season}赛季`),
