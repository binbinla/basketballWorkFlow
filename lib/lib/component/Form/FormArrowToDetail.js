...
class FormArrowToDetail extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(react_native_1.TouchableOpacity, { activeOpacity: 0.5, onPress: () => { this.props.onFormClick(); } }, React.createElement(react_native_1.View, { style: [styles.container, cutOffLineStyle] }, React.createElement(react_native_1.Text, { style: [styles.text] }, this.props.leftText), React.createElement(react_native_1.Image, { source: require('../../../assets/img/indicate/arrow-right.png'), style: styles.image }))));
    }
}
