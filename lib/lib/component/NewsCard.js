...
class NewsCard extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(react_native_1.View, { style: [styles.container] }, React.createElement(react_native_1.Image, { source: newsImage, style: styles.imageContainer }), React.createElement(react_native_1.View, { style: styles.textContainer }, React.createElement(react_native_1.Text, { style: styles.text }, newsTitle))));
    }
}
