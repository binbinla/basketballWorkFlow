...
class TeamCard extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(react_native_1.View, { style: [styles.container] }, React.createElement(react_native_1.View, { style: styles.leftContainer }, React.createElement(react_native_1.Text, { style: styles.rankingText }, this.props.rank), React.createElement(react_native_1.View, { style: { marginLeft: 15 } }, React.createElement(react_native_1.Text, { style: styles.areaText }, " ", area, " "), React.createElement(react_native_1.Text, { style: styles.teamNameText }, " ", teamName, " "))), React.createElement(react_native_1.View, { style: styles.rightContainer }, React.createElement(react_native_1.Text, { style: styles.scoreText }, `${this.props.item.win}胜-${this.props.item.loss}负`), React.createElement(react_native_1.Image, { style: styles.image, source: logo }))));
    }
}
