...
class LoginPage extends React.Component {
    ...
    render() {
        return (React.createElement(react_native_1.View, { style: styles.container }, React.createElement(react_native_1.View, { style: styles.card }, React.createElement(react_native_textinput_effects_1.Hoshi, { style: { backgroundColor: colors_1.commonColors.white }, label: '账号', maskColor: '#F9F7F6', borderColor: '#b76c94', onChangeText: (text) => { this.setState({ account: text }); } }), React.createElement(react_native_textinput_effects_1.Hoshi, { style: { backgroundColor: colors_1.commonColors.white }, label: '密码', maskColor: '#F9F7F6', borderColor: '#b76c94', secureTextEntry: true, onChangeText: (text) => { this.setState({ password: text }); } })), React.createElement(Button_1.default, { text: '登录', onButtonClick: () => this.loginInPress() }), React.createElement(react_native_easy_toast_1.default, { ref: "toast", position: "center" })));
    }
}
