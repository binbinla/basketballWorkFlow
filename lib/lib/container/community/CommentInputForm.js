...
class CommentInputForm extends React.Component {
    ...
    render() {
        return (React.createElement(react_native_1.View, { style: [styles.container] }, React.createElement(react_native_1.TouchableOpacity, { style: styles.touchLine, onPress: this._inputLineOnPress.bind(this) }, React.createElement(react_native_1.Text, { style: styles.text }, '我来评论...'))));
    }
}
