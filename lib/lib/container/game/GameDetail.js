...
class GameDetail extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(react_native_1.View, { style: styles.container }, React.createElement(GameCard_1.default, { item: this.state.gameItem, bgColor: topicColor, atDetail: true }), React.createElement(ScrollableTabView, { initialPage: 0, tabBarUnderlineStyle: { backgroundColor: topicColor }, tabBarActiveTextColor: topicColor, locked: true }, React.createElement(GamePlayerCard_1.default, { tabLabel: `${team_map_1.default[this.state.gameItem.home.teamAbbreviate].team}` }), React.createElement(GamePlayerCard_1.default, { tabLabel: `${team_map_1.default[this.state.gameItem.visitor.teamAbbreviate].team}` }))));
    }
}
