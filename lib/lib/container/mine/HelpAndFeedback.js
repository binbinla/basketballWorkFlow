...
class HelpAndFeedback extends React.Component {
    ...
    render() {
        return (React.createElement(react_native_1.View, { style: styles.container }, React.createElement(react_native_1.TextInput, { style: [styles.titleContainer, { textAlignVertical: 'top' }], onChangeText: this._onChangeTitleText, underlineColorAndroid: "transparent", multiline: true, placeholder: '请输入您的反馈主题' }), React.createElement(react_native_1.TextInput, { style: [styles.inputContainer, { textAlignVertical: 'top' }], onChangeText: this._onChangeContentText,
            // onChange={this._onChange}
            underlineColorAndroid: "transparent", multiline: true, placeholder: '请提出您宝贵的意见' }), React.createElement(Button_1.default, { text: '提交', onButtonClick: this._submitClick, disabled: this.state.disabled }), React.createElement(react_native_easy_toast_1.default, { ref: "toast", position: "center" })));
    }
}
