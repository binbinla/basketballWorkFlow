...
class HomePage extends React.Component {
    ...
    render() {
        return (React.createElement(react_native_1.View, { style: styles.container }, React.createElement(GiftedListView, { rowView: this._renderRowView, onFetch: this._onFetch, firstLoader: true, pagination: true, refreshable: true, withSections: false, customStyles: {
                paginationView: {
                    backgroundColor: '#eee',
                },
    ...
    _renderRowView(left, right) {
        return (React.createElement(react_native_1.TouchableOpacity, { activeOpacity: 0.8, onPress: () => this._onItemPress(left, right) }, React.createElement(GameCard_1.default, { homeTeamItem: left, guestTeamItem: right })));
    }
    /**
