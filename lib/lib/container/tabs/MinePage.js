...
class MinePage extends React.Component {
    ...
    render() {
        return (React.createElement(react_native_1.View, { style: styles.container }, React.createElement(react_native_1.ScrollView, { style: { flex: 1 } }, React.createElement(react_native_1.View, { style: styles.partContainer }, React.createElement(FormWithPicture_1.default, { nickName: '大陈', contactText: '188****6910', pictureUri: '../../../assets/img/indicate/snail.jpg', onFormClick: () => this.personalProfile() }), React.createElement(FormWithPairText_1.default, { leftText: "\u6211\u7684\u79EF\u5206", rightText: "180", onFormClick: () => this.aboutTheApp(), cutOffLine: false })), React.createElement(react_native_1.View, { style: styles.partContainer }, React.createElement(FormArrowToDetail_1.default, { leftText: '我的主队', onFormClick: () => this.aboutTheApp(), cutOffLine: false })), React.createElement(react_native_1.View, { style: styles.partContainer }, React.createElement(FormArrowToDetail_1.default, { leftText: '意见与反馈', onFormClick: () => this.helpAndFeedback() }), React.createElement(FormArrowToDetail_1.default, { leftText: '给个好评鼓励一下吧', onFormClick: () => this.evaluateApp() }), React.createElement(FormArrowToDetail_1.default, { leftText: '关于App', onFormClick: () => this.aboutTheApp(), cutOffLine: false })), React.createElement(Button_1.default, { style: { marginTop: 15, backgroundColor: colors_1.commonColors.topicColor }, text: "\u9000\u51FA\u767B\u5F55", onButtonClick: () => this.logout() }))));
    }
}
