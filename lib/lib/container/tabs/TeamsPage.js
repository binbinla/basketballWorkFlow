...
class TeamsPage extends React.Component {
    ...
    */
    ...
    _renderRowView(item, index) {
        ...
        return (React.createElement(react_native_1.TouchableOpacity, { style: { paddingTop: 10 }, activeOpacity: 0.8, onPress: () => this._onItemPress(item) }, React.createElement(TeamCard_1.default, { item: item, rank: this.rank++ })));
    }
    /**
