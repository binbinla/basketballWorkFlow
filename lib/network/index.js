...
const news_test_from_api_1 = __importDefault(require("../mock_datas/news_test_from_api"));
class Channel {
    // private options;
    // constructor(options) {
    ...
    getRecentNews(num, start) {
        const result = producer_1.default.recentNBANews(JSON.parse(news_test_from_api_1.default));
        return result;
    }
}
