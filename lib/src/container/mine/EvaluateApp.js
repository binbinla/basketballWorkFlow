...
class EvaluateApp extends React.Component {
    ...
    render() {
        return (React.createElement(react_native_1.View, { style: styles.container },
            React.createElement(react_native_1.View, { style: styles.starContainer },
                React.createElement(react_native_star_rating_1.default, { disabled: false, maxStars: 5, rating: this.state.starCount, selectedStar: this._onStarRatingPress, fullStarColor: colors_1.commonColors.topicColor })),
            React.createElement(react_native_1.View, { style: styles.illustrationContainer },
                React.createElement(react_native_1.Text, { style: styles.text }, "\u8F7B\u70B9\u661F\u5F62\u6765\u8BC4\u5206\uFF0C\u76F8\u4FE1\u6211\u4F1A\u53D8\u5F97\u66F4\u597D\u54E6\uFF01")),
            React.createElement(Button_1.default, { text: '提交评分', onButtonClick: this._submitEvaluate, disabled: this.state.buttonDisabled }),
