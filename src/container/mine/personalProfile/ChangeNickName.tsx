...
interface DispathProps {
  readonly modifyNickName: (nickName: string) => Action<void>
}
...
class ChangeNickName extends React.Component<Props, State> {
...
function mapDispatchToProps() {
  return (dispatch: any) => ({
    modifyNickName: (nickName: string) => dispatch(loginAction.modifyNickName(nickName))
  })
}
