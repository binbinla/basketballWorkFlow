...
export interface whatState {
  // 用类json的方法进行映射，暂不需要拿到整个数据结构体。
  // 但是如果本地想该数据，比如增加某条新闻的评论，如何处理？
  ids: string[]
}

const test_item_one: NewsState = {
  newsId: 100001,
...
const test_item_three: NewsState = {
  newsId: 100003,
...
const anotherInitial: NewsState[] = []
